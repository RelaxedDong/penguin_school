...
<view style="min-height: 220rpx">
  <view class="scroll_box padding-10 fixed">
...
<view class="page-container">
  ...
  <view bindtouchstart="touchStart" class="activity-list shadow margin-top-10" bindtap="DetailClick" data-id="{{activity.id}}" qq:for="{{activities}}" qq:key qq:for-item="activity">
